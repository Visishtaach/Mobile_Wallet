  ...
  return (
    <SafeAreaView style={[styles.container, { margin: insets.top }]}>
      ...
      <View style={styles.buttons}>
        <TouchableOpacity>
          <Text
            style={[styles.btnText, { left: 10.5, textAlign: 'center' }]}
            onPress={() => {
              fingerPrintCaptureHandlers();
            }}
          >
            <Ionicons
        ...
        <TouchableOpacity onPress={() => cancelHandler()}>
          <Text style={[styles.btnText, { left: -11, textAlign: 'center' }]}>
            X
          </Text>
        </TouchableOpacity>
      </View>
